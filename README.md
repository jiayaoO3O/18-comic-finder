...
**20210816 重要通知📢 由于禁漫天堂在2021年8月11日更新了新的切割算法, 不是固定将图片切割成10份了, 而是用了某一个新的切割方式, 所以比较新的漫画会显示错乱, 目前我还没找到对应的规律, 如果有前端js大佬知道新的切割算法是通过什么参数来确定切割份数的, 能告诉我一下, 那就太好了. 目前下载功能还可以用, 但是对于最新的漫画章节内容处理会错乱.**
